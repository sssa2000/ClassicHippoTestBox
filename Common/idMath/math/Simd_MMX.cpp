...
============
*/
const char * H3DSIMD_MMX::GetName( void ) const {
	return "MMX";
}
...
================
*/
void VPCALL H3DSIMD_MMX::Memcpy( void *dest0, const void *src0, const int count0 ) {
...
================
*/
void VPCALL H3DSIMD_MMX::Memset( void* dest0, const int val, const int count0 ) {
	union {
		byte	bytes[8];
		word	words[4];
		dword	dwords[2];
