...
/******* H3DQuat Preliminaries *******/

/* Construct a (possibly non-unit) H3DQuat from real components. */
...
/* Return H3DQuat product qL * qR.  Note: order is important!
...
/* Return product of H3DQuat q by scalar w. */
...
/* Construct a unit H3DQuat from rotation matrix.  Assumes matrix is
...
/* Given a unit H3DQuat, q, and a scale vector, k, find a unit H3DQuat, p,
...
void decomp_affine(HMatrix A, AffineParts *parts)
{
	...
	parts->t = Qt_(A[3][0], A[3][1], A[3][2], 0);
