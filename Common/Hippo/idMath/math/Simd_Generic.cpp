...
/*
============
H3DSIMD_Generic::GetName
============
*/
const char * H3DSIMD_Generic::GetName( void ) const {
	return "generic code";
}
...
============
*/
void VPCALL H3DSIMD_Generic::Add( float *dst, const float constant, const float *src, const int count ) {
...
============
*/
void VPCALL H3DSIMD_Generic::Add( float *dst, const float *src0, const float *src1, const int count ) {
...
============
*/
void VPCALL H3DSIMD_Generic::Sub( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
...
============
*/
void VPCALL H3DSIMD_Generic::Sub( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] - src1[(X)];
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Mul( float *dst, const float constant, const float *src0, const int count) {
	double c = constant;
...
============
*/
void VPCALL H3DSIMD_Generic::Mul( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] = src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Div( float *dst, const float constant, const float *divisor, const int count ) {
	double c = constant;
...
============
*/
void VPCALL H3DSIMD_Generic::Div( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] = src0[(X)] / src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::MulAdd

  dst[i] += constant * src[i];
============
*/
void VPCALL H3DSIMD_Generic::MulAdd( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
#define OPER(X) (dst[(X)] += c * src[(X)])
	UNROLL4(OPER)
#undef OPER
...
============
*/
void VPCALL H3DSIMD_Generic::MulAdd( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] += src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::MulSub

  dst[i] -= constant * src[i];
============
*/
void VPCALL H3DSIMD_Generic::MulSub( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
#define OPER(X) (dst[(X)] -= c * src[(X)])
	UNROLL4(OPER)
#undef OPER
...
============
*/
void VPCALL H3DSIMD_Generic::MulSub( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] -= src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DVec3 &constant, const H3DVec3 *src, const int count ) {
#define OPER(X) dst[(X)] = constant.Dot(src[(X)]);
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DVec3 &constant, const H3DPlane *src, const int count ) {
//#define OPER(X) dst[(X)] = constant * src[(X)].Normal() + src[(X)][3];
	#define OPER(X) dst[(X)] = constant.Dot(src[(X)].Normal()) + src[(X)][3];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DVec3 &constant, const H3DDrawVert *src, const int count ) {
//#define OPER(X) dst[(X)] = constant * src[(X)].xyz;
	#define OPER(X) dst[(X)] = constant.Dot(src[(X)].xyz);
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DPlane &constant, const H3DVec3 *src, const int count ) {
//#define OPER(X) dst[(X)] = constant.Normal() * src[(X)] + constant[3];
	#define OPER(X) dst[(X)] = constant.Normal().Dot(src[(X)]) + constant[3];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DPlane &constant, const H3DPlane *src, const int count ) {
//#define OPER(X) dst[(X)] = constant.Normal() * src[(X)].Normal() + constant[3] * src[(X)][3];
	#define OPER(X) dst[(X)] = constant.Normal().Dot(src[(X)].Normal()) + constant[3] * src[(X)][3];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DPlane &constant, const H3DDrawVert *src, const int count ) {
//#define OPER(X) dst[(X)] = constant.Normal() * src[(X)].xyz + constant[3];
#define OPER(X) dst[(X)] = constant.Normal().Dot(src[(X)].xyz) + constant[3];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float *dst, const H3DVec3 *src0, const H3DVec3 *src1, const int count ) {
//#define OPER(X) dst[(X)] = src0[(X)] * src1[(X)];
	#define OPER(X) dst[(X)] = src0[(X)].Dot(src1[(X)]);
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::Dot( float &dot, const float *src1, const float *src2, const int count ) {
#if 1
...
/*
============
H3DSIMD_Generic::CmpGT

  dst[i] = src0[i] > constant;
============
*/
void VPCALL H3DSIMD_Generic::CmpGT( byte *dst, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL H3DSIMD_Generic::CmpGT( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
...
/*
============
H3DSIMD_Generic::CmpGE

  dst[i] = src0[i] >= constant;
============
*/
void VPCALL H3DSIMD_Generic::CmpGE( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] >= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::CmpGE( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] >= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::CmpLT

  dst[i] = src0[i] < constant;
============
*/
void VPCALL H3DSIMD_Generic::CmpLT( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] < constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::CmpLT( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] < constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::CmpLE

  dst[i] = src0[i] <= constant;
============
*/
void VPCALL H3DSIMD_Generic::CmpLE( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] <= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::CmpLE( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] <= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::MinMax
============
*/
void VPCALL H3DSIMD_Generic::MinMax( float &min, float &max, const float *src, const int count ) {
	min = H3DMath::INFINITY; max = -H3DMath::INFINITY;
...
============
*/
void VPCALL H3DSIMD_Generic::MinMax( H3DVec2 &min, H3DVec2 &max, const H3DVec2 *src, const int count ) {
	min[0] = min[1] = H3DMath::INFINITY; max[0] = max[1] = -H3DMath::INFINITY;
#define OPER(X) const H3DVec2 &v = src[(X)]; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::MinMax( H3DVec3 &min, H3DVec3 &max, const H3DVec3 *src, const int count ) {
	min[0] = min[1] = min[2] = H3DMath::INFINITY; max[0] = max[1] = max[2] = -H3DMath::INFINITY;
#define OPER(X) const H3DVec3 &v = src[(X)]; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::MinMax( H3DVec3 &min, H3DVec3 &max, const H3DDrawVert *src, const int count ) {
	min[0] = min[1] = min[2] = H3DMath::INFINITY; max[0] = max[1] = max[2] = -H3DMath::INFINITY;
#define OPER(X) const H3DVec3 &v = src[(X)].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL H3DSIMD_Generic::MinMax( H3DVec3 &min, H3DVec3 &max, const H3DDrawVert *src, const int *indexes, const int count ) {
	min[0] = min[1] = min[2] = H3DMath::INFINITY; max[0] = max[1] = max[2] = -H3DMath::INFINITY;
#define OPER(X) const H3DVec3 &v = src[indexes[(X)]].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::Clamp
============
*/
void VPCALL H3DSIMD_Generic::Clamp( float *dst, const float *src, const float min, const float max, const int count ) {
...
/*
============
H3DSIMD_Generic::ClampMin
============
*/
void VPCALL H3DSIMD_Generic::ClampMin( float *dst, const float *src, const float min, const int count ) {
...
/*
============
H3DSIMD_Generic::ClampMax
============
*/
void VPCALL H3DSIMD_Generic::ClampMax( float *dst, const float *src, const float max, const int count ) {
...
/*
================
H3DSIMD_Generic::Memcpy
================
*/
void VPCALL H3DSIMD_Generic::Memcpy( void *dst, const void *src, const int count ) {
	memcpy( dst, src, count );
}

/*
================
H3DSIMD_Generic::Memset
================
*/
void VPCALL H3DSIMD_Generic::Memset( void *dst, const int val, const int count ) {
	memset( dst, val, count );
}

/*
============
H3DSIMD_Generic::Zero16
============
*/
void VPCALL H3DSIMD_Generic::Zero16( float *dst, const int count ) {
	memset( dst, 0, count * sizeof( float ) );
}

/*
============
H3DSIMD_Generic::Negate16
============
*/
void VPCALL H3DSIMD_Generic::Negate16( float *dst, const int count ) {
...
/*
============
H3DSIMD_Generic::Copy16
============
*/
void VPCALL H3DSIMD_Generic::Copy16( float *dst, const float *src, const int count ) {
...
/*
============
H3DSIMD_Generic::Add16
============
*/
void VPCALL H3DSIMD_Generic::Add16( float *dst, const float *src1, const float *src2, const int count ) {
...
/*
============
H3DSIMD_Generic::Sub16
============
*/
void VPCALL H3DSIMD_Generic::Sub16( float *dst, const float *src1, const float *src2, const int count ) {
#define OPER(X) dst[(X)] = src1[(X)] - src2[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::Mul16
============
*/
void VPCALL H3DSIMD_Generic::Mul16( float *dst, const float *src1, const float constant, const int count ) {
...
/*
============
H3DSIMD_Generic::AddAssign16
============
*/
void VPCALL H3DSIMD_Generic::AddAssign16( float *dst, const float *src, const int count ) {
#define OPER(X) dst[(X)] += src[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::SubAssign16
============
*/
void VPCALL H3DSIMD_Generic::SubAssign16( float *dst, const float *src, const int count ) {
#define OPER(X) dst[(X)] -= src[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
H3DSIMD_Generic::MulAssign16
============
*/
void VPCALL H3DSIMD_Generic::MulAssign16( float *dst, const float constant, const int count ) {
...
/*
============
H3DSIMD_Generic::MatX_MultiplyVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_MultiplyVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, j, numRows;
...
/*
============
H3DSIMD_Generic::MatX_MultiplyAddVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_MultiplyAddVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_MultiplySubVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_MultiplySubVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_TransposeMultiplyVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_TransposeMultiplyVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_TransposeMultiplyAddVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_TransposeMultiplyAddVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_TransposeMultiplySubVecX
============
*/
void VPCALL H3DSIMD_Generic::MatX_TransposeMultiplySubVecX( H3DVecX &dst, const H3DMatX &mat, const H3DVecX &vec ) {
	int i, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_MultiplyMatX
...
============
*/
void VPCALL H3DSIMD_Generic::MatX_MultiplyMatX( H3DMatX &dst, const H3DMatX &m1, const H3DMatX &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
...
/*
============
H3DSIMD_Generic::MatX_TransposeMultiplyMatX
...
============
*/
void VPCALL H3DSIMD_Generic::MatX_TransposeMultiplyMatX( H3DMatX &dst, const H3DMatX &m1, const H3DMatX &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
	const float *m1Ptr, *m2Ptr;
	double sum;
...
/*
============
H3DSIMD_Generic::MatX_LowerTriangularSolve
...
============
*/
void VPCALL H3DSIMD_Generic::MatX_LowerTriangularSolve( const H3DMatX &L, float *x, const float *b, const int n, int skip ) {
#if 1
...
/*
============
H3DSIMD_Generic::MatX_LowerTriangularSolveTranspose
...
============
*/
void VPCALL H3DSIMD_Generic::MatX_LowerTriangularSolveTranspose( const H3DMatX &L, float *x, const float *b, const int n ) {
#if 1
...
/*
============
H3DSIMD_Generic::BlendJoints
============
*/
void VPCALL H3DSIMD_Generic::BlendJoints( H3DJointQuat *joints, const H3DJointQuat *blendJoints, const float lerp, const int *index, const int numJoints ) {
	int i;
...
/*
============
H3DSIMD_Generic::ConvertJointQuatsToJointMats
============
*/
void VPCALL H3DSIMD_Generic::ConvertJointQuatsToJointMats( H3DJointMat *jointMats, const H3DJointQuat *jointQuats, const int numJoints ) {
	int i;
...
/*
============
H3DSIMD_Generic::ConvertJointMatsToJointQuats
============
*/
void VPCALL H3DSIMD_Generic::ConvertJointMatsToJointQuats( H3DJointQuat *jointQuats, const H3DJointMat *jointMats, const int numJoints ) {
	int i;
...
/*
============
H3DSIMD_Generic::TransformJoints
============
*/
void VPCALL H3DSIMD_Generic::TransformJoints( H3DJointMat *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
/*
============
H3DSIMD_Generic::UntransformJoints
============
*/
void VPCALL H3DSIMD_Generic::UntransformJoints( H3DJointMat *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
/*
============
H3DSIMD_Generic::TransformVerts
============
*/
void VPCALL H3DSIMD_Generic::TransformVerts( H3DDrawVert *verts, const int numVerts, const H3DJointMat *joints, const H3DVec4 *weights, const int *index, int numWeights ) {
	int i, j;
	...
	for( j = i = 0; i < numVerts; i++ ) {
		...
		v = ( *(H3DJointMat *) ( jointsPtr + index[j*2+0] ) ) * weights[j];
		while( index[j*2+1] == 0 ) {
			j++;
			v += ( *(H3DJointMat *) ( jointsPtr + index[j*2+0] ) ) * weights[j];
		}
...
/*
============
H3DSIMD_Generic::TracePointCull
============
*/
void VPCALL H3DSIMD_Generic::TracePointCull( byte *cullBits, byte &totalOr, const float radius, const H3DPlane *planes, const H3DDrawVert *verts, const int numVerts ) {
	int i;
	byte tOr;
...
/*
============
H3DSIMD_Generic::DecalPointCull
============
*/
void VPCALL H3DSIMD_Generic::DecalPointCull( byte *cullBits, const H3DPlane *planes, const H3DDrawVert *verts, const int numVerts ) {
	int i;
...
/*
============
H3DSIMD_Generic::OverlayPointCull
============
*/
void VPCALL H3DSIMD_Generic::OverlayPointCull( byte *cullBits, H3DVec2 *texCoords, const H3DPlane *planes, const H3DDrawVert *verts, const int numVerts ) {
	int i;
...
/*
============
H3DSIMD_Generic::DeriveTriPlanes

	Derives a plane equation for each triangle.
============
*/
void VPCALL H3DSIMD_Generic::DeriveTriPlanes( H3DPlane *planes, const H3DDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;

	for ( i = 0; i < numIndexes; i += 3 ) {
		const H3DDrawVert *a, *b, *c;
		float d0[3], d1[3], f;
		H3DVec3 n;
		...
		f = H3DMath::RSqrt( n.x * n.x + n.y * n.y + n.z * n.z );
...
/*
============
H3DSIMD_Generic::DeriveTangents
...
============
*/
void VPCALL H3DSIMD_Generic::DeriveTangents( H3DPlane *planes, H3DDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;

	bool *used = (bool *)_alloca16( numVerts * sizeof( used[0] ) );
	memset( used, 0, numVerts * sizeof( used[0] ) );

	H3DPlane *planesPtr = planes;
	for ( i = 0; i < numIndexes; i += 3 ) {
		H3DDrawVert *a, *b, *c;
		...
		f = H3DMath::RSqrt( t0.x * t0.x + t0.y * t0.y + t0.z * t0.z );
		*(unsigned long *)&f ^= signBit;
		...
		f = H3DMath::RSqrt( t1.x * t1.x + t1.y * t1.y + t1.z * t1.z );
		*(unsigned long *)&f ^= signBit;
...
/*
============
H3DSIMD_Generic::DeriveUnsmoothedTangents
...
void VPCALL H3DSIMD_Generic::DeriveUnsmoothedTangents( H3DDrawVert *verts, const dominantTri_s *dominantTris, const int numVerts ) {
	int i;
...
/*
============
H3DSIMD_Generic::NormalizeTangents
...
============
*/
void VPCALL H3DSIMD_Generic::NormalizeTangents( H3DDrawVert *verts, const int numVerts ) {

	for ( int i = 0; i < numVerts; i++ ) {
		H3DVec3 &v = verts[i].normal;
		float f;

		f = H3DMath::RSqrt( v.x * v.x + v.y * v.y + v.z * v.z );
		v.x *= f; v.y *= f; v.z *= f;

		for ( int j = 0; j < 2; j++ ) {
			H3DVec3 &t = verts[i].tangents[j];

			t -= ( t.Dot(v) ) * v;
			f = H3DMath::RSqrt( t.x * t.x + t.y * t.y + t.z * t.z );
			t.x *= f; t.y *= f; t.z *= f;
		}
	}
}
...
/*
============
H3DSIMD_Generic::CreateTextureSpaceLightVectors
...
============
*/
void VPCALL H3DSIMD_Generic::CreateTextureSpaceLightVectors( H3DVec3 *lightVectors, const H3DVec3 &lightOrigin, const H3DDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	...
	for ( int i = 0; i < numVerts; i++ ) {
		...
		const H3DDrawVert *v = &verts[i];

		H3DVec3 lightDir = lightOrigin - v->xyz;

		//lightVectors[i][0] = lightDir * v->tangents[0];
		//lightVectors[i][1] = lightDir * v->tangents[1];
		//lightVectors[i][2] = lightDir * v->normal;
		lightVectors[i][0] = lightDir.Dot(v->tangents[0]);
		lightVectors[i][1] = lightDir.Dot(v->tangents[1]);
		lightVectors[i][2] = lightDir.Dot(v->normal);
	}
}

/*
============
H3DSIMD_Generic::CreateSpecularTextureCoords
...
============
*/
void VPCALL H3DSIMD_Generic::CreateSpecularTextureCoords( H3DVec4 *texCoords, const H3DVec3 &lightOrigin, const H3DVec3 &viewOrigin, const H3DDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	...
	for ( int i = 0; i < numVerts; i++ ) {
		...
		H3DVec3 lightDir = lightOrigin - v->xyz;
		H3DVec3 viewDir = viewOrigin - v->xyz;

		float ilength;

		//ilength = H3DMath::RSqrt( lightDir * lightDir );
		ilength = H3DMath::RSqrt( lightDir.Dot(lightDir) );
		lightDir[0] *= ilength;
		lightDir[1] *= ilength;
		lightDir[2] *= ilength;

		//ilength = H3DMath::RSqrt( viewDir * viewDir );
		ilength = H3DMath::RSqrt( viewDir.Dot(viewDir) );
		viewDir[0] *= ilength;
		viewDir[1] *= ilength;
		viewDir[2] *= ilength;
		...
		texCoords[i][0] = lightDir.Dot(v->tangents[0]);
		texCoords[i][1] = lightDir.Dot(v->tangents[1]);
		texCoords[i][2] = lightDir.Dot(v->normal);
		texCoords[i][3] = 1.0f;
	}
}
...
/*
============
H3DSIMD_Generic::CreateShadowCache
============
*/
int VPCALL H3DSIMD_Generic::CreateShadowCache( H3DVec4 *vertexCache, int *vertRemap, const H3DVec3 &lightOrigin, const H3DDrawVert *verts, const int numVerts ) {
	int outVerts = 0;
...
/*
============
H3DSIMD_Generic::CreateVertexProgramShadowCache
============
*/
int VPCALL H3DSIMD_Generic::CreateVertexProgramShadowCache( H3DVec4 *vertexCache, const H3DDrawVert *verts, const int numVerts ) {
	for ( int i = 0; i < numVerts; i++ ) {
		const float *v = verts[i].xyz.ToFloatPtr();
...
/*
============
H3DSIMD_Generic::UpSamplePCMTo44kHz

  Duplicate samples for 44kHz output.
============
*/
void H3DSIMD_Generic::UpSamplePCMTo44kHz( float *dest, const short *src, const int numSamples, const int kHz, const int numChannels ) {
	if ( kHz == 11025 ) {
		if ( numChannels == 1 ) {
...
/*
============
H3DSIMD_Generic::UpSampleOGGTo44kHz

  Duplicate samples for 44kHz output.
============
*/
void H3DSIMD_Generic::UpSampleOGGTo44kHz( float *dest, const float * const *ogg, const int numSamples, const int kHz, const int numChannels ) {
	if ( kHz == 11025 ) {
		if ( numChannels == 1 ) {
			for ( int i = 0; i < numSamples; i++ ) {
...
/*
============
H3DSIMD_Generic::MixSoundTwoSpeakerMono
============
*/
void VPCALL H3DSIMD_Generic::MixSoundTwoSpeakerMono( float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2] ) {
	float sL = lastV[0];
	float sR = lastV[1];
...
/*
============
H3DSIMD_Generic::MixSoundTwoSpeakerStereo
============
*/
void VPCALL H3DSIMD_Generic::MixSoundTwoSpeakerStereo( float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2] ) {
	float sL = lastV[0];
	float sR = lastV[1];
	float incL = ( currentV[0] - lastV[0] ) / MIXBUFFER_SAMPLES;
	float incR = ( currentV[1] - lastV[1] ) / MIXBUFFER_SAMPLES;
...
/*
============
H3DSIMD_Generic::MixSoundSixSpeakerMono
============
*/
void VPCALL H3DSIMD_Generic::MixSoundSixSpeakerMono( float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6] ) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
H3DSIMD_Generic::MixSoundSixSpeakerStereo
============
*/
void VPCALL H3DSIMD_Generic::MixSoundSixSpeakerStereo( float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6] ) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
H3DSIMD_Generic::MixedSoundToSamples
============
*/
void VPCALL H3DSIMD_Generic::MixedSoundToSamples( short *samples, const float *mixBuffer, const int numSamples ) {
