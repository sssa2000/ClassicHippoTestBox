...
============
*/
float SSE3_Dot( const H3DVec4 &v1, const H3DVec4 &v2 ) {
	float d;
	__asm {
		mov		esi, v1
		mov		edi, v2
...
/*
============
H3DSIMD_SSE3::GetName
============
*/
const char * H3DSIMD_SSE3::GetName( void ) const {
	return "MMX & SSE & SSE2 & SSE3";
}

/*
============
H3DSIMD_SSE3::TransformVerts
============
*/
void VPCALL H3DSIMD_SSE3::TransformVerts( H3DDrawVert *verts, const int numVerts, const H3DJointMat *joints, const H3DVec4 *weights, const int *index, const int numWeights ) {
#if 1
