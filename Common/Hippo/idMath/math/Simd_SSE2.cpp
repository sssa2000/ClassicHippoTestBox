...
/*
============
H3DSIMD_SSE2::GetName
============
*/
const char * H3DSIMD_SSE2::GetName( void ) const {
	return "MMX & SSE & SSE2";
}
...
/*
============
H3DSIMD_SSE2::MatX_LowerTriangularSolve
...
============
*/
void VPCALL H3DSIMD_SSE2::MatX_LowerTriangularSolve( const H3DMatX &L, float *x, const float *b, const int n, int skip ) {
	int nc;
	const float *lptr;
...
/*
============
H3DSIMD_SSE2::MatX_LowerTriangularSolveTranspose
...
============
*/
void VPCALL H3DSIMD_SSE2::MatX_LowerTriangularSolveTranspose( const H3DMatX &L, float *x, const float *b, const int n ) {
	int nc;
	const float *lptr;
...
/*
============
H3DSIMD_SSE2::MixedSoundToSamples
============
*/
void VPCALL H3DSIMD_SSE2::MixedSoundToSamples( short *samples, const float *mixBuffer, const int numSamples ) {
